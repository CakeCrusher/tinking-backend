...
app.post('/submitFeedback', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                feedbackInput = req.body.input.feedback;
                description = feedbackInput.description;
                if (!feedbackInput.steps) return [3 /*break*/, 2];
                steps = feedbackInput.steps;
                return [4 /*yield*/, makeTinkProcess(steps)];
            case 1:
                tinkID = _a.sent();
                _a.label = 2;
            case 2: return [4 /*yield*/, getFeedback(description, tinkID)];
            case 3:
                feedbackID = _a.sent();
...
app.post('/makeTink', function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var steps, tinkID;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
